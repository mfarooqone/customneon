        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              autoText(
                  "If the Goods arrive to you in a damaged state, you are required to notify the delivery agent\nand us (the Seller) within 24 hours in writing inclusive of photography or a video evidence of\nthe damage to the Goods and associated packaging to verify. Failure to comply with this\nrequest and timeframe will void our obligations."),
              SizedBox(
                height: 2.h,
              ),
              autoText(
                  "You shall inspect the Goods on delivery and shall within forty-eight (48) hours of delivery\nnotify us (the Seller) in writing of any alleged defect, shortage in quantity, damage or failure\nto comply with the description or quote."),
              SizedBox(
                height: 2.h,
              ),
              autoText(
                  "You shall afford us an opportunity to inspect the Goods within a reasonable time following\ndelivery. If you fail to comply with these provisions, the Goods shall be conclusively presumed\nto be in accordance with the terms and conditions and free from any defect or damage."),
              SizedBox(
                height: 2.h,
              ),
              autoText(
              ...
              autoText(
                  "To be eligible for a return, your item(s) must be in the same condition that you received them\nand in the original packaging. You’ll also need the receipt or proof of purchase."),
              SizedBox(
                height: 2.h,
              ),
              autoText(
              ...
              autoText(
                  "Due to the handmade nature of neon sign products, they can be subject to variations and\nslight discolorations. Some colors may also vary as a result from printer calibration or\ncomputer screen settings; however this should be considered an error in production since\nthese fluctuations make each item even more unique"),
              SizedBox(
                height: 6.h,
              ),
              autoText(
